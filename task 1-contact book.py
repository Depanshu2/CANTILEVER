...
root.config(bg = '#240740')
root.title('Contact Book Project')
root.resizable(0,0)
contactlist = []
...
select = Listbox(frame, yscrollcommand=scroll.set,font=('Times new roman',16),bg="#4B70F5",width=25,height=20,borderwidth=3,relief="groove")
...
Button(root,text=" ADD", font=("Times new roman",16),bg='#e8c1c7', command = AddContact, padx=20). place(x= 50, y=140)
